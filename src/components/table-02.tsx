...
const rows: Table02Row[] = [
  { id: 1, col1: 'TBody Col 01', col2: 'TBody Col 02', col3: 'TBody Col 03' },
  { id: 2, col1: 'TBody Col 01', col2: 'TBody Col 02', col3: 'TBody Col 03' },
  { id: 3, col1: 'TBody Col 01', col2: 'TBody Col 02', col3: 'TBody Col 03' },
  { id: 4, col1: 'TBody Col 01', col2: 'TBody Col 02', col3: 'TBody Col 03' },
  { id: 5, col1: 'TBody Col 01', col2: 'TBody Col 02', col3: 'TBody Col 03' },
];
...
const Table02: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-[800px] mx-auto rounded-radius-4 shadow-shadow bg-white overflow-hidden">
        ...
        <tbody>
          {rows.map((row) => (
            <tr key={row.id} className="border-b border-gray-200 last:border-b-0">
              <td className="p-spacing-4 text-xs text-text-secondary font-600">{row.col1}</td>
              <td className="p-spacing-4 text-xs text-brand-tertiary font-600">{row.col2}</td>
              <td className="p-spacing-4 text-xs text-brand-tertiary font-600">{row.col3}</td>
              <td className="p-spacing-4">
                <div className="flex items-center gap-1.5">
                  ...
                  <button
                    ...
                    aria-label="Edit"
                    data-tooltip-target={`tooltip-edit-02-${row.id}`}
                  >
                    <EditIcon />
                  </button>
                  <div
                    id={`tooltip-edit-02-${row.id}`}
                    role="tooltip"
                  ...
                  <button
                    ...
                    className="p-1 hover:bg-gray-50 rounded transition-colors"
                    aria-label="Delete"
                    data-tooltip-target={`tooltip-delete-02-${row.id}`}
                  >
                    <DeleteIcon />
                  </button>
                  <div
                    id={`tooltip-delete-02-${row.id}`}
                    role="tooltip"
                    className="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip"
                  >
                    Delete
