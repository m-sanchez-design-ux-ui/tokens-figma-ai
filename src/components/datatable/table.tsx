    ...
    <div className="w-full max-w-4xl rounded-radius-4 shadow-shadow bg-white overflow-hidden">
      <table className="w-full table-fixed">
        ...
        <thead className="bg-gray-50">
          <tr>
            <th className="w-1/5 p-spacing-4 text-left text-sm text-brand-tertiary font-600 uppercase border-b border-gray-200">
              COL
            </th>
            <th className="w-1/5 p-spacing-4 text-left text-sm text-brand-tertiary font-600 uppercase border-b border-gray-200">
              COL
        ...
        <tbody>
          {data.map((row) => (
            <tr key={row.id} className="border-b border-gray-200 last:border-b-0">
              <td className="w-1/5 p-spacing-4 text-xs text-text-secondary font-600 truncate" title={row.col1}>
                {row.col1}
              </td>
              <td className="w-1/5 p-spacing-4 text-xs text-brand-tertiary font-600 truncate" title={row.col2}>
                {row.col2}
              </td>
              <td className="w-1/5 p-spacing-4 text-xs text-brand-tertiary font-600 truncate" title={row.col3}>
                {row.col3}
              </td>
              <td className="w-1/5 p-spacing-4 text-xs text-brand-tertiary font-600 truncate" title={row.col4}>
                {row.col4}
              </td>
              <td className="w-1/5 p-spacing-4 whitespace-nowrap">
